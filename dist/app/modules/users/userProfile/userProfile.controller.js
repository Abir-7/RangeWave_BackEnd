...
const updateUserProfile = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield userProfile_service_1.UserProfileService.updateUserProfile(req.user.userEmail, userData);
...
//
exports.UserProfileController = { updateUserProfile };
