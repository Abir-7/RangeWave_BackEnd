...
const sendMessage = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield message_service_1.MessageService.sendMessage(req.user.userId, req.body);
...
const getMessage = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield message_service_1.MessageService.getMessage(req.user.userId, req.params.roomId);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
